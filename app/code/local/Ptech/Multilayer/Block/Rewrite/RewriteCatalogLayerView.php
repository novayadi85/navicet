 ...
 * @Class        Ptech_Multilayer_Block_Rewrite_RewriteCatalogLayerView
 * @Overwrite    Mage_Catalog_Block_Layer_View
 */ 
class Ptech_Multilayer_Block_Rewrite_RewriteCatalogLayerView extends Mage_Catalog_Block_Layer_View
{
